#
#  Configuration file for the NEWFIRM DHS  (Clean Room Config).  
#
...
Supervisor newfirm-CR.tuc.noao.edu	/ndhs/bin/super -name Super -port 4150

# Pan A processes
Collector  nfdhs-01-CR.tuc.noao.edu	/ndhs/bin/collector -console \
						-port 4550 -id PanA
SMCMgr     nfdhs-01-CR.tuc.noao.edu	/ndhs/bin/smcmgr -console -mbus \
			-dev fast:inet:3201:140.252.52.168
PXF        nfdhs-01-CR.tuc.noao.edu 	/ndhs/bin/pxf -console -mbus
...
# Pan B processes
Collector  nfdhs-02-CR.tuc.noao.edu	/ndhs/bin/collector -console \
						-port 4551 -id PanB
SMCMgr     nfdhs-02-CR.tuc.noao.edu	/ndhs/bin/smcmgr -console -mbus \
			-dev fast:inet:3201:140.252.52.168
PXF        nfdhs-02-CR.tuc.noao.edu 	/ndhs/bin/pxf -console -mbus
...
NF-DCA     newfirm-CR.tuc.noao.edu     /ndhs/bin/mosdca -debug 2 \
                                        -reqlevel 2 \
...
pair	localhost			newfirm-CR.tuc.noao.edu

pair	newfirm-CR.tuc.noao.edu		nfdhs-01-CR.tuc.noao.edu
pair	nfpan-a-CR.tuc.noao.edu		nfdhs-01-CR.tuc.noao.edu
pair	nfpan-b-CR.tuc.noao.edu		nfdhs-02-CR.tuc.noao.edu

pair	newfirm-CR			nfdhs-01-CR
pair	nfpan-a-CR			nfdhs-01-CR
pair	nfpan-b-CR			nfdhs-02-CR

pair	newfirm-CR			nfdhs-01-CR.tuc.noao.edu
pair	nfpan-a-CR			nfdhs-01-CR.tuc.noao.edu
pair	nfpan-b-CR			nfdhs-02-CR.tuc.noao.edu

pair	newfirm-CR.tuc.noao.edu		nfdhs-01-CR
pair	nfpan-a-CR.tuc.noao.edu		nfdhs-01-CR
pair	nfpan-b-CR.tuc.noao.edu		nfdhs-02-CR
