# 		DCA Keyword Translation Module for MOSAIC1.1
# 
# Input:
...
if {! [info exists srcdir]}  {set srcdir  /dhs/lib}
if {! [info exists homedir]} {set homedir /home/observer}
set ngui		.ngui
set datafile 		mosaic1.dat
set mapfiles(NOCS) 	NOCS.map
set mapfiles(Pan) 	PAN.map
set mapunknown 		yes
set maplevel 		0

source ${srcdir}/mosaic1src.tcl
if {[catch { mosaic1 } err]} {
